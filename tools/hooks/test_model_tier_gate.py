...
class TestCachedItemList(unittest.TestCase):
    ...
    def test_resolve_estimate_uses_cache_across_two_calls(self):
        """End-to-end: two resolve_estimate() calls (simulating two
        ...
        with patch("model_tier_gate._run", side_effect=fake_run), \
            ...
            e1 = m.resolve_estimate("/some/cwd", 999)
            e2 = m.resolve_estimate("/some/cwd", 999)

        self.assertEqual(e1, 8)
        self.assertEqual(e2, 8)
